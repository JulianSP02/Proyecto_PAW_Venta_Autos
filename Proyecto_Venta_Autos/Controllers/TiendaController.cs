...
namespace Proyecto_Venta_Autos.Controllers
{
    public class TiendaController : Controller
    {
        ...
        public IActionResult Producto(int idproducto = 0)
        {
            ...
            oProducto = (from o in oLista
                         ...
                         select new Producto()
                         {
                             ...
                             base64 = utilidades.convertirBase64(Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", o.RutaImagen)),
        ...
        [HttpPost]
        public JsonResult InsertarCarrito([FromBody] Carrito oCarrito)
        {
                ...
                oLista = (from d in oLista
                          select new Carrito()
                          {
                              ...
                              oProducto = new Producto()
                              {
                                  ...
                                  base64 = utilidades.convertirBase64(Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", d.oProducto.RutaImagen)),
        ...
        [HttpPost]
        public JsonResult RegistrarCompra([FromBody] Compra oCompra)
        {
            bool respuesta = false;
                          ...
                          oDetalleCompra = (from dc in c.oDetalleCompra
                                            select new DetalleCompra()
                                            {
                                                oProducto = new Producto()
                                                {
                                                    ...
                                                    base64 = utilidades.convertirBase64(Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", dc.oProducto.RutaImagen)),
